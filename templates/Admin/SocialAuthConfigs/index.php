...
<section class="bca-section" data-bca-section-type="form-group">
  ...
  <div class="bca-section__content">
    ...
    <?php if (!$isWritableEnv): ?>
      <p class="bca-text-warning"><?php echo __d('baser_core', '.env に書き込みできないため、この画面では保存できません。必要なキーを手作業で設定してください。') ?></p>
    <?php endif ?>
...
<section class="bca-section" data-bca-section-type="form-group">
  <h2 class="bca-main__heading" data-bca-heading-size="lg"><?php echo h($label) ?></h2>
  <table class="form-table bca-form-table section" data-bca-table-type="type2">
